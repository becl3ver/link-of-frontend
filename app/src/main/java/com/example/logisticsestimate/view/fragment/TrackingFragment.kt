...
/**
 * 선박 위치를 조회하고, 구글 맵 API 이용해서 해당 위치 마킹
 */
class TrackingFragment: Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        binding.fragmentTrackingBtnSearch.setOnClickListener {
            val intent = Intent(context, ShipTrackingActivity::class.java)
            getResult.launch(intent)
        }

        val mapFragment = childFragmentManager.findFragmentById(R.id.fragment_tracking_map) as SupportMapFragment?
